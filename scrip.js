...
function saludar() {
 ...
 //Llamado a la funcion//
    ...
    function calcular impuestos  (valorBase, impuPais, impuGanancias, impuBP){
    ...
    let sumar Impuestos= valorBase*impuPais+valorBase*impuPais+valorBase*impuGanancias+valorBase*impuBP
